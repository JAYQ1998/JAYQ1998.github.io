...
还有几种比较特殊的数据结构（HyperLogLogs、Bitmap 、Geospatial、Stream）也非常重要，我们后面下次再聊！
...
![图片](Redis 5 种基础数据结构.assets/640.png)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/iaIdQfEric9TzQYEGvw2y6O6ZnyI3oM0MppKKVNVOOo5GNbO5v4CyQ03qcnOALftJxUicnoQm2hMF7DJNaWK34sPg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/iaIdQfEric9TzQYEGvw2y6O6ZnyI3oM0MpdU3LSddyn2icDicdsvM6UMF5NxX2BG6HRTmDOB5ZwgkqlkV5u7Q3n8qA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/iaIdQfEric9TzQYEGvw2y6O6ZnyI3oM0MpUaibQwfsfxG65OKONkAfWJcL9osA3XM2CCHPCWNPfXWq87Cjiaye6E4Q/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
你可以基于 Set 轻易实现交集、并集、差集的操作，比如你可以将一个用户所有的关注人存在一个集合中，将其所有粉丝存在一个集合。这样的话，Set 可以非常方便的实现如共同关注、共同粉丝、共同喜好等功能。这个过程也就是求交集的过程。![图片](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)
...
## Sorted Set（有序集合）- TreeSet + HashMap
...
[《Java 面试指北》](https://mp.weixin.qq.com/s?__biz=Mzg2OTA0Njk0OA==&mid=2247525881&idx=1&sn=33d4565668cff95f5ee239c6e1d660fe&chksm=cea12a32f9d6a324432c964bf536181f2d55ee50afba9a53d9b09fa0e1a7126a03bb1dde4c60&token=698289097&lang=zh_CN&scene=21#wechat_redirect) 的「技术面试题篇」就有一篇文章详细介绍如何使用 Sorted Set 来设计制作一个排行榜。
